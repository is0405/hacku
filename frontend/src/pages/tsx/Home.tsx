      ...
      <div className='background_home'>
        <div className='topDiv_home'>
          ...
          <div className='topRight_home'>
            <img className="systemImage_home" src={system}></img>
          </div>
        </div>
        ...
        <div className='divFlex_home'>
          <div className='bottomLeft_home'>
            ...
            <div className="divFlex_home">
              <img className="image_home" src={emoji1}></img>
              <div className="opinion_home">・・・バイアスがかからないよう研究室外の被験者を集めたい...</div>
            </div>
            <div className="divFlex_home">
              <img className="image_home" src={emoji3}></img>
              <div className="opinion_home">・・・条件を満たす被験者を集めたい...</div>
            </div>
            <div className="divFlex_home">
              <img className="image_home" src={emoji4}></img>
          ...
          <div className='bottomRight_home'>
            ...
            <div className="divFlex_home">
              <img className="image_home" src={emoji5}></img>
              <div className="opinion_home">・・・多くの実験に参加したいけど、どんな実験があるの？</div>
            </div>
            <div className="divFlex_home">
              <img className="image_home" src={emoji6}></img>
              <div className="opinion_home">・・・謝礼が欲しい！</div>
            </div>
            <div className="divFlex_home">
              <img className="image_home" src={emoji7}></img>
        ...
        <div className="bottomImage">
          <img className="hukidashi_home" src={hukidashi}></img>
